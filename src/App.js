...
function App() {
  ...
  useEffect(()=>{
    num+=1;
    axios.get("https://drf-api-for-todo.vercel.app/todos")
    .then(res => {
      setTodos(res.data)
...
// add todo function
  const addTodo = (data) => {
    ...
    axios.post("https://drf-api-for-todo.vercel.app/todos", data)
  ...
  const delTodo = (id) => {
    ...
    axios.delete("https://drf-api-for-todo.vercel.app/todos/"+id)
    .catch(
      err=> {
  ...
  const updateTodo = (e, id, text, todo) => {
    ...
    axios.patch("https://drf-api-for-todo.vercel.app/todos/"+id,updatedTodo)
